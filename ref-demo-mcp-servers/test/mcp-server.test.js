...
describe('MCP Server Template Tests', () => {
    ...
    describe('Health Check', () => {
        test('should respond to GET request with health status', async () => {
            ...
            expect(body.server).toBe('rd-mcp')
    ...
    describe('MCP Protocol', () => {
        test('should handle initialize request', async () => {
            ...
            expect(body.result.serverInfo.name).toBe('rd-mcp')
        })
        ...
        test('should include echo, calculator, and weather tools', async () => {
            ...
            expect(toolNames).toEqual(expect.arrayContaining(['echo', 'calculator', 'weather', 'export_content_fragment_to_target']))
